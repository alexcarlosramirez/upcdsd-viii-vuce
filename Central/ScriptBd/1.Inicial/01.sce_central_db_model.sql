...
create table if not exists tce (
	...
	fecha_registro datetime,
	entidad_id int,
	estado varchar(1) COMMENT 'Valores: A=Pendiente Env�o, B=Pendiente de Pago, C=Pendiente de Respuesta de la Entidad, D=Pendiente de evaluacion, E=Aprobado, F=Rechazado',
...
create table if not exists traza (
	...
	estado_traza int COMMENT 'Valores: 1: Solicitud registrada, 2: Solicitud transmitida, 3: Tasa Generada, 4: Pago Recibido, 5: Suce generada, 6: Respuesta de la entidad con Nro de Expediente, 7: Emisi�n de DR de aprobaci�n, 8: Emisi�n de DR de denegaci�n',
	tce_id int,
	orden_id int,
	mto int,
	dr_id int,
...
insert into tupa values (2,'25','Autorización de Exportaci�n Productos Diversos',2,'I');
